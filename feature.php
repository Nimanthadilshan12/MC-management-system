...
<head>
    ...
    <style>
        ...
        .dark-mode {
         ...
         .page-header {
            background-image: url('img/5d8a440c-2092-40eb-8d47-be6222518fb9.jpg');
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="feature.php" class="nav-item nav-link active">Opening Information</a>
            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.1s">
                    <div class="p-lg-5 ps-lg-0">
                        <h1 class="text-white mb-4">Medical Centre Information</h1>
                        <p class="text-white mb-4 pb-2">The University of Ruhuna Medical Centre is open to serve students, staff, and the university community as the following:</p>
                        <div class="row g-4">
                            <div class="col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="settings_value">
                                        <p class="text-white mb-2">Opening Hours</p>
                                        <h5 class="text-white mb-0"><?php echo htmlspecialchars($settings['opening_time'] . ' - ' . $settings['closing_time']); ?></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="settings_value">
                                        <p class="text-white mb-2">Emergency Contact</p>
                                        <h5 class="text-white mb-0"><?php echo htmlspecialchars($settings['emergency_contact_number']); ?></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-10">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="settings_value">
                                        <p class="text-white mb-2">Days of Operation</p>
                                        <h5 class="text-white mb-0"><?php echo htmlspecialchars($operation_days_text); ?></h5>
                                    </div>
                                </div>
                            </div>
                            <p class="text-white mb-4 pb-2">For emergencies outside regular hours, please contact the nearest hospital or medical facility. The Medical Centre is committed to providing accessible and timely healthcare services to support your well-being.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 pe-lg-0 wow fadeIn" data-wow-delay="0.5s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute img-fluid w-100 h-100" src="img/dreamstime_l_126710064.jpg" style="object-fit: cover;" alt="">
                    </div>
                </div>
            </div>
        </div>
