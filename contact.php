...
<head>
    ...
    <!-- Inline CSS for Dark Mode and Contact Styling -->
    <style>
        /* Color Variables */
        :root {
            --primary: rgb(86, 85, 183); /* Purple, added to match login.php and about.html */
            --accent: #06b6d4; /* Cyan */
        ...
        .dark-mode h1, .dark-mode h3, .dark-mode .border.rounded-pill {
            color: var(--text-light) !important;
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="contact.php" class="nav-item nav-link active active">Contact</a>
        ...
        <div class="container">
            ...
            <div class="row g-4 mb-5">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="h-100 bg-light rounded d-flex align-items-center p-5 contact-card">
                        <div class="d-flex flex-shrink-0 align-items-center justify-content-center rounded-circle bg-white" style="width: 70px; height: 70px;">
                            <i class="fa fa-map-marker-alt text-primary"></i>
                        </div>
                        <div class="ms-4">
                            <p class="mb-2 fs-5">Address</p>
                            <h3 class="mb-0">University of Ruhuna, Matara, Sri Lanka</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="h-100 bg-light rounded d-flex align-items-center p-5 contact-card">
                        ...
                        <div class="ms-4">
                            <p class="mb-2 fs-5">Call Us Now</p>
                            <h3 class="mb-0"><?php echo htmlspecialchars($settings['emergency_contact_number']); ?></h3>
                            
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100 bg-light rounded d-flex align-items-center p-9 contact-card">
                        <div class="d-flex flex-shrink-0 align-items-center justify-content-center rounded-circle bg-white" style="width: 70px; height: 70px;">
                            <i class="fa fa-envelope-open text-primary"></i>
                        </div>
                        <div class="ms-4">
                            <p class="mb-2 fs-5">Mail Us Now</p>
                            <h3 class="mb-0">medicalcentre@ruh.ac.lk</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 wow fadeIn" data-wow-delay="0.1s">
                    <div class="h-100" style="min-height: 400px;">
                        <iframe class="rounded w-100 h-100"
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3967.131187299694!2d80.57461811477458!3d5.936558195697104!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae1390053b0cf11%3A0xe24ade5731dd2724!2sUniversity%20Medical%20Center!5e0!3m2!1sen!2slk!4v1697584321987!5m2!1sen!2slk"
